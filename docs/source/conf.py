...
project = 'Automatic assessment'
copyright = '2019, Florian Desrumaux, Antoine Grandjacquot'
author = 'Florian Desrumaux, Antoine Grandjacquot'
...
htmlhelp_basename = 'Automaticassessmentdoc'
...
latex_documents = [
    (master_doc, 'Automaticassessment.tex', 'Automatic assessment Documentation',
     'Florian Desrumaux, Antoine Grandjacquot', 'manual'),
]
...
man_pages = [
    (master_doc, 'automaticassessment', 'Automatic assessment Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Automaticassessment', 'Automatic assessment Documentation',
     author, 'Automaticassessment', 'One line description of project.',
     'Miscellaneous'),
]
